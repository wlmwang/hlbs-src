...
/* Always refer to the globals in your function as HLBS_G(variable).
   You are encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/
#define HLBS_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(hlbs, v)

#if defined(ZTS) && defined(COMPILE_DL_HLBS)
